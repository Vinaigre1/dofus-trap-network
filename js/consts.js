...
const TRAP = {
  ...
  TRICKY:        { id: 1,  color: { stroke: 'rgb(194,  23,  26)', cell: 'rgba(178,  77,  64, 0.5)' }, area: { type: AREA.CROSS,    size: 1 }, degressive: true,  effects: [{ type: EFFECT.DAMAGE.FIRE,      value: { min: 26, max: 28 }, area: { type: AREA.CROSS,    size: 1 } }, { type: EFFECT.PULL,         value: { min: 1,   max: 1 },   area: { type: AREA.CROSS,    size: 1 } }] },
  ...
  DRIFT:         { id: 5,  color: { stroke: 'rgb(194,  23,  26)', cell: 'rgba(175,  90,  74, 0.62)' }, area: { type: AREA.DIAGONAL, size: 1 }, degressive: true,  effects: [{ type: EFFECT.DAMAGE.FIRE,      value: { min: 17, max: 19 }, area: { type: AREA.DIAGONAL, size: 1 } }, { type: EFFECT.PUSH,         value: { min: 2,   max: 2 },   area: { type: AREA.DIAGONAL, size: 1 } }] },
  MALEVOLENT:    { id: 6,  color: { stroke: 'rgb( 84,  39,  20)', cell: 'rgba( 84,  39,  20, 0.25)' }, area: { type: AREA.CELL,     size: 0 }, degressive: true,  effects: [{ type: EFFECT.MALEVOLENT_BOOST, value: { min: 20, max: 20 }, area: { type: AREA.CIRCLE,   size: 2 } }, { type: EFFECT.DAMAGE.EARTH, value: { min: 28,  max: 32 },  area: { type: AREA.CELL,     size: 0 } }] },
  ...
  REPELLING:     { id: 9,  color: { stroke: 'rgb(157, 235, 147)', cell: 'rgba(157, 235, 147, 0.37)' }, area: { type: AREA.CROSS,    size: 1 }, degressive: true,  effects: [{ type: EFFECT.PUSH,             value: { min: 2,  max: 2 },  area: { type: AREA.CROSS,    size: 1 } }, { type: EFFECT.DAMAGE.AIR,   value: { min: 12,  max: 12 },  area: { type: AREA.CROSS,    size: 1 } }] },
  ...
  LETHAL:        { id: 11, color: { stroke: 'rgb( 84,  39,  20)', cell: 'rgba( 84,  39,  20, 0.25)' }, area: { type: AREA.CELL,     size: 0 }, degressive: true,  effects: [{ type: EFFECT.DAMAGE.EARTH,     value: { min: 39, max: 43 }, area: { type: AREA.CELL,     size: 0 } }] },
