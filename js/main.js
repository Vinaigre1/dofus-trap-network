...
let spellData = [
  ...
  { name: 'Piège de Dérive', icon: img[9], type: SPELL.TRAP, effects: { trap: { ...TRAP.DRIFT, image: img[18] } } },
  { name: 'Piège à Fragmentation', icon: img[11], type: SPELL.TRAP, effects: { trap: { ...TRAP.FRAGMENTATION, image: img[18] } } },
  { name: 'Piège de Masse', icon: img[6], type: SPELL.TRAP, effects: { trap: { ...TRAP.MASS, image: img[18] } } },
  { name: 'Piège Mortel', icon: img[7], type: SPELL.TRAP, effects: { trap: { ...TRAP.LETHAL, image: img[18] } } },
  { name: 'Piège Funeste', icon: img[8], type: SPELL.TRAP, effects: { trap: { ...TRAP.MALEVOLENT, image: img[18] } } },
  { name: 'Piège Répulsif', icon: img[3], type: SPELL.TRAP, effects: { trap: { ...TRAP.REPELLING, image: img[18] } } },
  { name: 'Piège Insidieux', icon: img[5], type: SPELL.TRAP, effects: { trap: { ...TRAP.INSIDIOUS, image: img[18] } } },
